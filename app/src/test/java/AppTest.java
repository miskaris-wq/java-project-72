...
public class AppTest {
    ...
    @Test
    void testMainPage() throws SQLException, IOException {
    ...
    @Test
    void testListUrlsPage() throws SQLException, IOException {
        var url = new Url();
    ...
    @Test
    void testShowUrlPage() throws SQLException, IOException {
        var url = new Url();
